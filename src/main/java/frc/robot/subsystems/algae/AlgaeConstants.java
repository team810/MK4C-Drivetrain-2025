...
public class AlgaeConstants {
    ...
    public static final Angle STORED_ANGLE = Degrees.of(55);
    ...
    public static final Distance LASER_TOLERANCE = Inches.of(2);
    public static final Distance LASER_EXPECTED = Inches.of(3);
